...
function Page() {
    ...
    const [fields, setFields] = useState([
        ...
        },
        {
            ...
            multiSelect: false,
            req: true,
            options: bodyTypesData?.data?.map((item) => ({
                ...
                <form className='formContainer' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="inputCont btnCont">
                        <button
                            ...
                            type="submit"
                            className={`themeBtn ${!isValid ? "disabled" : ""} ${brandMutation.isPending ? "disabled" : ""}`}
                            onClick={() => console.log("Button clicked, isValid:", isValid, "isPending:", brandMutation.isPending)}
                        >
