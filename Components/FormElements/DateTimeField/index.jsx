                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <DatePicker
                            ...
                            disabled={props.isFieldDisabled || props?.readOnly}
                            // minDate={new Date()}
                            customInput={
                                <div
                                    className={`input date-input ${props.isFieldDisabled || props?.readOnly
                                            ? "--isDisabled"
                                            : ""
                                        }`}
                                >
                                    <span
                                        className={`title ${field.value
                                                ? "title-col"
                                                : "placeholder-col"
                                            } ${props.error ? "error-col" : ""}`}
                                    >
                                        {field.value
                                            ? props.dateOption &&
                                                !props.timeOption
