        ...
        <>
            <section className="listingSec">
                ...
                <div className="carsContainer">
                    <BreadCrumb city={currentCity} route={route} />
                    <div className="productGrid">
                        <div className="filteredCars">
                            <div className="pageHeader">
                                <h1>Car Rental Dubai</h1>
                                <p>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident, laborum.
                                    Reiciendis possimus itaque quis officia.
                                </p>
                            </div>
                            <Advertisement />
            ...
            {/* <section className="contentSec">
                <div className="carsContainer">
                    <div className="content">
                        ...
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae a reiciendis veniam
                            consequuntur vel modi nam voluptatibus quos inventore debitis architecto, saepe at, nesciunt
                            eum! Veritatis harum magnam, obcaecati voluptatum rem sed ab qui similique illum asperiores,
                            quasi pariatur, voluptates in recusandae reiciendis! Commodi ab rem dolorem veniam,
                            dignissimos quisquam reiciendis quidem. Nemo earum inventore tenetur doloremque illo
                            quisquam beatae quasi? Nisi asperiores placeat provident, fugit sunt explicabo perferendis
                            blanditiis distinctio animi voluptatem facere hic corporis obcaecati libero cupiditate
                            mollitia voluptas reprehenderit eius eaque expedita ad voluptates doloremque! Fugit
                            perspiciatis corrupti reiciendis debitis adipisci eveniet culpa beatae quaerat nisi
                            sapiente?
                        </p>
                        <SecHeading heading={"Lorem Ipsum"} />
                        <ul>
