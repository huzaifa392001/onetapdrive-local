            ...
            <div className="content">
                <Link href={`/product/${product?.slug}`}>
                    <h3>
                        ...
                        <span>
                            ...
                            {product?.seatingCapacity?.name} with
                            {product?.features?.slice(0, 3)?.map((item) => `${item?.name}, `)}
                        </span>
                    </h3>
                </Link>
                ...
                <div className="btnCont">
                    <figure className="brandImgCont">
                        <Image src={product?.user?.vendorProfile[0]?.companyLogo} width={40} height={40} alt="" />
                    </figure>
                    <Link href={""} className="call">
                        ...
                        <span>{product?.user?.vendorProfile[0]?.whatsappNumber}</span>
                    </Link>
